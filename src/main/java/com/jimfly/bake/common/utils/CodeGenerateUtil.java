package com.jimfly.bake.common.utils;
...
public class CodeGenerateUtil {
    public static void main(String[] args) {
        ...
        String packageName = "com.jimfly.bake";
    ...
    private PackageConfig getPackageConfig(String packageName,String projectName) {
        return new PackageConfig()
                ...
                .setXml("dao."+projectName+".mapper")
                .setMapper("dao."+projectName+".mapper")
    ...
    private DataSourceConfig getDataSourceConfig() {
        return new DataSourceConfig().setDbType(DbType.MYSQL)
                .setUrl("jdbc:mysql://127.0.0.1:3306/bake?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&useSSL=false")
                .setUsername("root")
